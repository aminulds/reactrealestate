...
const EditeListing = () => {
  ...
  const onSubmit = async (e) => {
    ...
    setLoadding(false);
    toast.success("Successfully Listing Updated!");
  ...
  return (
    <main className='max-w-md px-2 mx-auto my-6'>
      <h1 className='text-3xl text-center font-bold'>Update Listing</h1>
      ...
      <form onSubmit={onSubmit}>
        ...
        <button type='submit' className='w-full bg-blue-600 text-white px-6 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Update Listing</button>
